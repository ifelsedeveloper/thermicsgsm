...
public class SystemConfigSQLiteHelper extends SQLiteOpenHelper {
	public static final String TABLE_SYSTEMS = "systems";
	  ...
	  public SystemConfigSQLiteHelper(Context context) {
	  ...
	  public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
	    Log.w(SystemConfigSQLiteHelper.class.getName(),
